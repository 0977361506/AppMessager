$ (function(){
	...
	document.querySelector("#sendding").addEventListener("change",function(e){
		...
		reader.onload = function(e){
            ...
            // if(file.type=='image/jpeg' || file.type=='image/jpg' || file.type=='image/gif' || file.type=='image/png' || file.type =='image/webp'){
            //     el.innerHTML = `
            //     <div class="progress">0%</div>
            //     <img id="image" style="max-width: 300px; max-height: 300px;" />
            //     `;
            //     document.querySelector("#contentchat-list").appendChild(el);

            //     const blob = new Blob([reader.result], {type: 'image/png'});  // ảnh 
            //     let src = URL.createObjectURL(blob);
            //     console.log("src",src)
            //     var myImg = el.querySelector("#image");
            //     myImg.src= src;  // ảnh
                
            // }else if(file.type=='video/mp4' || file.type=='video/3gpp'|| file.type=='video/webm' || file.type=='video/wmb'){
            //     el.innerHTML = `
            //     <div class="progress">0%</div>
            //     <video autoplay controls id="video" style="max-width: 300px; max-height: 300px;"></video>
            //     `;
            //     document.querySelector("#contentchat-list").appendChild(el);
            //     var myvideo = el.querySelector("#video");
            //     let videoBlob = new Blob([buffer], { type: 'video/mp4' });
            //     let url = window.URL.createObjectURL(videoBlob);
            //     myvideo.src = url;
            // }else {
            //     console.log("file khác")
            // }
